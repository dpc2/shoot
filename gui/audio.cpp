...
//#include <cguid.h>                 // for GUID_nullptr
//
...
//{
//	dmusic3DAudioPath = nullptr;
//	dmusicLoader = nullptr;
//	dmusicPerformance = nullptr;
//	ds3DListener = nullptr;
//}
//
//// destructor
//CAudioSystem::~CAudioSystem()
...
//	if (FAILED(CoCreateInstance(CLSID_DirectMusicLoader, nullptr, CLSCTX_INPROC,
...
//	if (FAILED(CoCreateInstance(CLSID_DirectMusicPerformance, nullptr, CLSCTX_INPROC,
...
//	dmusicPerformance->InitAudio(nullptr, nullptr, hwnd, DMUS_APATH_SHARED_STEREOPLUSREVERB, 64,
//						    DMUS_AUDIOF_ALL, nullptr);
//
...
//     if (FAILED(dmusic3DAudioPath->GetObjectInPath(0, DMUS_PATH_PRIMARY_BUFFER, 0, GUID_nullptr, 0,
...
//{
//	// stop the music
//	dmusicPerformance->Stop(nullptr, nullptr, 0, 0);
//
...
//		dmusicPerformance->PlaySegmentEx(dmSeg, nullptr, nullptr, DMUS_SEGF_DEFAULT, 0,
//                           nullptr, nullptr, dmusic3DAudioPath);
//	}
//}
//
//// Play()
...
//
//		// play the segment on the next beat using the 3d audio path
//		dmusicPerformance->PlaySegmentEx(audio->GetSegment(), nullptr, nullptr, DMUS_SEGF_SECONDARY, 0,
//                           nullptr, nullptr, dmusic3DAudioPath);
//	}
//	else
//	{
...
//		// play the segment on the next beat using the 3d audio path
//		dmusicPerformance->PlaySegmentEx(audio->GetSegment(), nullptr, nullptr, DMUS_SEGF_DEFAULT, 0,
...
//     if (FAILED(dmusic3DAudioPath->GetObjectInPath(DMUS_PCHANNEL_ALL, DMUS_PATH_BUFFER, 0, GUID_nullptr, 0,
//                                                   IID_IDirectSound3DBuffer,
//                                                   (void**)&buff)))
//     {
//          MessageBox(nullptr, "Unable to retrieve 3D buffer from audiopath! Press OK to exit",
//                     "ERROR!", MB_OK);
//          return nullptr;
//     }
//
...
//                                                 (void**)&seg)))
//     {
//          MessageBox(nullptr, "Audio file not found! Press OK to exit",
//                     "ERROR!", MB_OK);
//
//          return nullptr;
//     }
